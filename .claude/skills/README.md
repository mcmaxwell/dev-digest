...
| [frontend-ui-architecture](frontend-ui-architecture/SKILL.md) | Frontend | React/Next.js code organization: folder structure, colocation, view → hook → service layering, import boundaries |
