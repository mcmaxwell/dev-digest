...
| Lesson | You build |
|--------|-----------|
| L01 | Run cost badge · severity filter on findings · [spec](docs/specs/L01-cost-badge.md) |
| L02 | Skills in the product · Conventions extractor · [spec](docs/specs/L02-skills.md) |
...
| L05 | Project Context Folder · Onboarding generator · PR Brief card · specs: [project-context](docs/specs/L05-project-context.md), [onboarding-tour](docs/specs/L05-onboarding-tour.md), [pr-brief](docs/specs/L05-pr-brief.md) |
| L06 | Eval pipeline · Secret/Phantom gates · Plan Verifier · Export to CI · specs: [eval-pipeline](docs/specs/L06-eval-pipeline.md), [export-ci](docs/specs/L06-export-ci.md) |
