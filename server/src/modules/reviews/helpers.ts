...
// skillToBlock moved to modules/_shared/skills.ts when `eval` became a second
// consumer; re-exported so existing imports from this file keep working.
export { skillToBlock } from '../_shared/skills.js';
