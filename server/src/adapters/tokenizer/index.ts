 ...
 *
 * Scope: in-process; consumers are modules/repo-intel (map budget) and the
 * review run's trace (skills-block token attribution). Swappable in tests via
 * a mock counter (ContainerOverrides.tokenizer).
 */
